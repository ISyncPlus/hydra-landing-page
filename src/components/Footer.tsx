  ...
  return (
    <footer className="py-5 px-3 lg:px-7 z-99 relative">
        <section className="flex justify-between items-center">
            ...
            <article className="flex flex-col items-center gap-6 font-bold flex-1 border-x-4 border-[#C0B7E8] rounded-xs">
            ...
            <article className="flex flex-col items-center gap-6 font-bold flex-1">
                <p>F.A.Q</p>
                <p>SITEMAP</p>
                <p>CONDITIONS</p>
                <p>LICENSES</p>
            ...
            <figure className="flex flex-col gap-10 flex-1 border-l-4 border-[#C0B7E8] py-3 pl-5">
                ...
                <Button variant="primary">BUILD YOUR WORLD</Button>
            </figure>
        </section>

        <img src={Vector_17} alt="v-17" className="my-20"/>
